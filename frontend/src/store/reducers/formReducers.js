...
export default (state = initState, action) => {
	switch (action.type) {	
				case formActions.SAVE_CLASS_SUCCESS:
			return {
				...state,
				data: action.payload,
				action: action.type,
		...
		case formActions.SAVE_FORM_SUCCESS:
			...
			case formActions.SAVE_USER_SUCCESS:
			return {
				...state,
				data: action.payload,
				action: action.type,
		...
		case formActions.GET_ALL_FORMS_SUCCESS:
			...
			case formActions.GET_ALL_RES_SUCCESS:
			return {
				...state,
				data: action.payload.response,
				totalResponses: action.payload.responseCount,
			...
			case formActions.GET_ALL_USERS_SUCCESS:
			return {
				...state,
				data: action.payload.response,
				totalResponses: action.payload.responseCount,
			...
			case formActions.GET_ALL_CLASSES_SUCCESS:
			return {
				...state,
				data: action.payload.response,
				totalResponses: action.payload.responseCount,
